  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-4">
        <span className="font-mono text-xs font-bold px-2 py-1 bg-brutal-accent text-brutal-black">
          NEWS RADAR
        </span>
        <span className="font-mono text-xs font-bold px-2 py-1 border border-brutal-accent text-brutal-accent">
      ...
      {/* Summary */}
      <p className="font-mono text-sm text-gray-400 leading-relaxed flex-1 line-clamp-4">
        {item.summary}
      </p>
